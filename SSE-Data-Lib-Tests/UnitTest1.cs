...
namespace SSE_Data_Lib_Tests
{
    ...
    public class UnitTest1
    {
        ...
        {
			var archive = await SSE.Resources.Archive.BSA105.Open(new FileInfo("C:\\Program Files (x86)\\Steam\\steamapps\\common\\Skyrim Special Edition\\Data\\Skyrim - Interface.bsa"));
